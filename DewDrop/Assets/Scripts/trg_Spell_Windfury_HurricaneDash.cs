...
public class trg_Spell_Windfury_HurricaneDash : AbilityTrigger
{
    ...
    {
        AbilityInstanceManager.CreateAbilityInstance("ai_Spell_Windfury_HurricaneDash", info.owner.transform.position + info.owner.GetCenterOffset(), Quaternion.identity, info);
    }
}
