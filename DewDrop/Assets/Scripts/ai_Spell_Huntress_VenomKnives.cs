...
public class ai_Spell_Huntress_VenomKnives : AbilityInstance
{
    ...
    protected override void OnCreate(CastInfo castInfo, object[] data)
    {
        ...
        {
            StatusEffect poison = new StatusEffect(castInfo.owner, StatusEffectType.DamageOverTime, poisonTime, poisonDamage);
            target.statusEffect.ApplyStatusEffect(poison);
            castInfo.owner.DoMagicDamage(initialDamage, target);
    ...
    private void BasicAttackHit(InfoBasicAttackHit hit)
    {
        ...
        {
            info.owner.DoMagicDamage(basicAttackBonusDamage, hit.to);
        }
    }
}
